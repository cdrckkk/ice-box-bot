        ...
        if "return_booking_id" in context.user_data:
            ...
            if update.message.photo:
                ...
                if mark_booking_returned(booking_id, photo.file_id):
                    await update.message.reply_text("✅ Return confirmed! 📸 Photo saved.\n\nType /start to return to menu.")
                else:
            ...
            user_name = text
            ice_box_id = context.user_data["ice_box_id"]
            start_time = context.user_data["start_time"]
            ...
            if booking_id:
                ...
                await update.message.reply_text("❌ Error creating booking. Please try again.")
